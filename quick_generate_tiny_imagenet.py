...
def quick_generate_tiny_imagenet_pretrained_vqgan():
    ...
    checkpoint_path = "checkpoints_variational/best_model_epoch_5.pt"
    ...
    for i in range(10):
        ...
        try:
            with torch.no_grad():
                ...
                # Decode to image using the correct zshape format for 256x256
                zshape = (1, 256, 16, 16)  # (batch, channels, height, width) for 256x256 -> 16x16 latent
                ...
                # Save image
                output_path = f"quick_generated_tiny_imagenet_pretrained_vqgan/test_{i+1:03d}.png"
